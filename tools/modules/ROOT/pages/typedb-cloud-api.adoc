...
1. Visit your https://cloud.typedb.com/?team_action=/settings[team settings,window=_blank] page,
...
See the xref:{page-version}@reference::cloud-http-api.adoc#accesslevels[API reference] for detailed access level info.
