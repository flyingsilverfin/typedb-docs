...
TypeDB transactions provide ACID guarantees up to **snapshot isolation**. For more details, see the server xref:{page-version}@core_concepts::typedb/transactions.adoc[Transaction] documentation.
...
#!test[reset-after]
#{{
include::{page-version}@core_concepts::example$driver/python_driver_usage.py[tag=setup_and_schema]

include::{page-version}@core_concepts::example$driver/python_driver_usage.py[tag=data_create]
#}}
...
#!test[reset-after]
#{{
include::{page-version}@core_concepts::example$driver/python_driver_usage.py[tag=import_and_constants]

include::{page-version}@core_concepts::example$driver/python_driver_usage.py[tag=driver_create]
include::{page-version}@core_concepts::example$driver/python_driver_usage.py[tag=database_create]
#}}

# SCHEMA transactions for schema changes
with driver.transaction(DB_NAME, TransactionType.SCHEMA) as tx:
    # Define new schema elements
include::{page-version}@core_concepts::example$driver/python_driver_usage.py[tag=tx_define_query]
...
* **xref:{page-version}@core_concepts::drivers/queries.adoc[Queries]** - Learn about query execution and result processing
* **xref:{page-version}@core_concepts::drivers/best-practices.adoc[Best Practices]** - Transaction management and performance optimization patterns