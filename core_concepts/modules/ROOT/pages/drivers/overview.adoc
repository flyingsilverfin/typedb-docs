...
include::{page-version}@core_concepts::example$driver/python_driver_setup.py[tag=import_and_constants]

# 1. Connect to TypeDB
include::{page-version}@core_concepts::example$driver/python_driver_setup.py[tag=driver_create]
    # 2. Initialize database with a schema  during application startup
include::{page-version}@core_concepts::example$driver/python_driver_setup.py[tag=database_create]
...
* Start with **xref:{page-version}@core_concepts::drivers/connections.adoc[Connections]** to learn about establishing server connections
* Learn about **xref:{page-version}@core_concepts::drivers/authentication.adoc[Authentication]** for secure access
* Understand **xref:{page-version}@core_concepts::drivers/transactions.adoc[Transactions]** for data consistency
* Use **xref:{page-version}@core_concepts::drivers/queries.adoc[Queries]** for reading and writing schema and data
* **xref:{page-version}@core_concepts::drivers/best-practices.adoc[Best Practices]** for ideal approaches and some tips and tricks
