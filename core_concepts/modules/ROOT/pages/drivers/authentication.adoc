...
#!test
#{{
include::{page-version}@core_concepts::example$driver/python_driver_setup.py[tag=import]
#}}
...
#{{
include::{page-version}@core_concepts::example$driver/python_driver_setup.py[tag=constants_address]
include::{page-version}@core_concepts::example$driver/python_driver_setup.py[tag=constants_options]
#}}
...
Note that if you are using an official xref:{page-version}@reference::typedb-http-drivers/index.adoc[TypeDB HTTP Driver],
this process is handled by the library.

For the full reference, see the xref:{page-version}@reference::typedb-http-api.adoc[TypeDB HTTP API] documentation.
