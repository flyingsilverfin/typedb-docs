...
although it is their supertype `organization` which is defined to play the role.
...
== References
* xref:{page-version}@reference::typeql/data_model.adoc#_type_system[Type system]
