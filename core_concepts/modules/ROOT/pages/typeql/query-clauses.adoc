...
== Query clauses
=== match
xref:{page-version}@core_concepts::typeql/query-variables-patterns.adoc#definition-match[Match clauses] read data by pattern-matching.
...
=== insert
xref:{page-version}@core_concepts::typeql/schema-data.adoc#_inserting_data[Insert clauses]
...
== References
* xref:{page-version}@reference::typeql/data_model.adoc#_data_pipelines[The Pipeline query model]
* xref:{page-version}@reference::typeql/pipelines/index.adoc[Clauses]
