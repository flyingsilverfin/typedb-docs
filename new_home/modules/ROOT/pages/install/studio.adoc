...
[cols-2]
--
.https://studio.typedb.com[Open TypeDB Studio in Web,window=_blank]
[.clickable]
****
Launch TypeDB Studio directly from your web browser.
****

.https://cloudsmith.io/~typedb/repos/public-release/packages/?q=name:%5Etypedb-studio[Download TypeDB Studio]
[.clickable]
****
