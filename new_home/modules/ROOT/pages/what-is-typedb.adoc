...
TypeDB integrates with pre-built tools: the web-based xref:{page-version}@new_home::install/studio.adoc[TypeDB Studio] and the command-line xref:{page-version}@new_home::install/console-cli.adoc[TypeDB Console].
