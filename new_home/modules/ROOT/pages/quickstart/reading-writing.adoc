...
Having defined the types in our schema, we are ready to write data to our database.

We'll see few examples of how we can create data,
...
include::./reading-writing.adoc[tag=insert1]
----
...
include::./reading-writing.adoc[tag=insert2]
----
...
----
#!test[write, db=quickstart]
include::./reading-writing.adoc[tag=insert3]
----
...
include::./reading-writing.adoc[tag=insert4]
----
...
Now we've seen how to create entities and attributes - shat about inserting relations?
...
[Note]
-----
Recall that each friendship takes _exactly two_ friends as specified in the schema; feel free to experiment though, and see what error messages TypeDB will give you when trying to insert triple friendships.
-----

[,typeql]
----
#!test[write, db=quickstart]
include::./reading-writing.adoc[tag=insert5]
----
...
include::./reading-writing.adoc[tag=match1]
----
...
----
#!test[read, db=quickstart]
include::./reading-writing.adoc[tag=match2]
----
...
Open a read transaction using `transaction read quickstart`, and execute the following query:
...
----
#!test[write, db=quickstart]
include::./reading-writing.adoc[tag=match-insert1]
----
