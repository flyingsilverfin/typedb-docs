...
[,typeql]
----
#!test[write, db=get-started, fail_at=commit]
...
[,typeql]
----
#!test[write, db=get-started, fail_at=runtime]
...
Here's the full set of queries you've used to write data into TypeDB:
[,typeql]
----
#!test[write, db=get-started]
include::./data.adoc[tag=successful-inserts]
