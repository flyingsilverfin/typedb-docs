...
You might also want to pop into the xref:{page-version}@tools::index.adoc[Tools] to read a bit more about TypeDB Studio and Console.

== Step 3: Get started guide

Once you have TypeDB installed, get up and running with a simple example at the xref:{page-version}@home::get_started/index.adoc[] guide.
This will teach you all the basics of TypeDB and TypeQL.

== Step 4: Examples

Explore some pre-built xref:{page-version}@examples::index.adoc[examples].
...
Start at the xref:{page-version}@core_concepts::typedb/overview.adoc[TypeDB Overview] to learn about the TypeDB server.

=== TypeQL

Understanding how to "think in TypeQL" is the key part of using TypeDB effectively and at full power.

The xref:{page-version}@core_concepts::typeql/overview.adoc[TypeQL Overview],
...
are described at the xref:{page-version}@core_concepts::drivers/overview.adoc[Driver Overview].
...
The xref:{page-version}@maintenance_operation::index.adoc[Operations] pages are for learning about backups, upgrades, configurations, and much more.
