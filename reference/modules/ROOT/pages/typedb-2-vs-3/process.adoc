...
. Refresh your knowledge and adjust to the new versions of TypeDB and TypeQL by following the updated xref:{page-version}@home::get_started/setup.adoc[Get started] guide.
...
This section showcases a step-by-step example of migrating a database between TypeDB 2.x and TypeDB 3.x using xref:{page-version}@maintenance_operation::database-export-import.adoc[export and import].
...
Visit xref:{page-version}@reference::typedb-2-vs-3/diff.adoc[] and xref:{page-version}@core_concepts::index.adoc[] to learn more about TypeDB 3.x.
Enjoy your journey!

[#_having_troubles]
== Having troubles?

For troubleshooting tips and guidance, refer to the xref:{page-version}@maintenance_operation::troubleshooting/index.adoc[Troubleshooting pages].
