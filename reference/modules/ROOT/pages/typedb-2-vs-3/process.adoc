...
. **Understand the scope of changes** by referring to the xref:{page-version}@reference::typedb-2-vs-3/diff.adoc[major changes] page.
. **Review the xref:{page-version}@reference::typedb-2-vs-3/diff.adoc#_temporarily_missing[missing features] list** before starting your migration.
Some features might not yet be available in 3.x, and you may need to wait for a newer version to proceed.
. Refresh your knowledge and adjust to the new versions of TypeDB and TypeQL by following the updated xref:{page-version}@home::get-started/setup.adoc[Get started] guide.
. **Migrate your TypeDB 2.x database** following the xref:#_step_by_step[step-by-step instructions below].
The setup process remains largely unchanged from 2.x.
. *Update your queries* using from 2.x syntax to 3.x syntax
. *Update your drivers* from 2.x APIs to 3.x APIs

Consult xref:{page-version}@reference::typedb-2-vs-3/diff.adoc#_major_changes_drivers[major driver changes] list for details.

[#_step_by_step]
== Step-by-step example

This section showcases a step-by-step example of migrating a database between TypeDB 2.x and TypeDB 3.x using xref:{page-version}@maintenance-operation::database-export-import.adoc[export and import].
...
[,typeql]
----
include::{page-version}@reference::partial$2_to_3/schema-2x.tql[tag=full-query]
----
====
...
==== Move attributes owned by attributes
...
[,typeql]
----
include::{page-version}@reference::partial$2_to_3/attribute-migration-queries.tql[tag=step1-define-entity-ownership]
----
...
[,typeql]
----
include::{page-version}@reference::partial$2_to_3/attribute-migration-queries.tql[tag=step2-move-data]
----
...
[,typeql]
----
include::{page-version}@reference::partial$2_to_3/attribute-migration-queries.tql[tag=step3-undefine-attribute-ownership]
----
...
- The xref:{page-version}@reference::typedb-2-vs-3/diff.adoc[major changes] page highlights the most common updates needed.
...
[,typeql]
----
include::{page-version}@reference::partial$2_to_3/schema-3x.tql[tag=full-query]
----
...
Launch a xref:{page-version}@home::install/index.adoc[new installation] and connect to it using a compatible xref:{page-version}@home::install/console-cli.adoc[TypeDB Console].
...
Visit xref:{page-version}@reference::typedb-2-vs-3/diff.adoc[] and xref:{page-version}@core-concepts::index.adoc[] to learn more about TypeDB 3.x.
Enjoy your journey!

[#_having_troubles]
== Having troubles?

For troubleshooting tips and guidance, refer to the xref:{page-version}@maintenance-operation::troubleshooting/index.adoc[Troubleshooting pages].
