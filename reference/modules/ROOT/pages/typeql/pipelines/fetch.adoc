= Fetch stage
:page-aliases: {page-version}@reference::typeql/queries/fetch.adoc
...
A fetch stage can follow any other stage that produces rows (e.g., xref:{page-version}@reference::typeql/pipelines/match.adoc[match], xref:{page-version}@reference::typeql/pipelines/insert.adoc[insert]).
...
See xref:{page-version}@reference::typeql/functions/index.adoc[] for more information about function returns.
====
