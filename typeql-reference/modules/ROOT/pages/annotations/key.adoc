...
=== Subtyping
Refer to xref:{page-version}@typeql-reference::annotations/unique.adoc#subtyping[unique constraint subtyping] and xref:{page-version}@typeql-reference::annotations/card.adoc#subtyping[card constraint subtyping] for the respective constraints' subtyping behavior.

== Limitations

Cannot be used with the xref:{page-version}@typeql-reference::annotations/unique.adoc[`@unique` annotation] and the xref:{page-version}@typeql-reference::annotations/card.adoc[`@card` annotation] as it produces same constraints.
