...
You can import your databases exported from TypeDB 2.x following xref:{page-version}@new_reference::typedb-2-vs-3/process.adoc[this guide].
====
...
This is the best tool you can use to migrate a database between two incompatible versions of TypeDB (e.g., a migration xref:{page-version}@new_reference::typedb-2-vs-3/process.adoc[from TypeDB 2.x to TypeDB 3.x]).
...
Check out xref:{page-version}@new_reference::typedb-2-vs-3/process.adoc[this page] for a detailed guide.
