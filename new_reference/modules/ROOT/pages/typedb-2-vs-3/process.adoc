...
. **Understand the scope of changes** by referring to the xref:{page-version}@new_reference::typedb-2-vs-3/diff.adoc[major changes] page.
. **Review the xref:{page-version}@new_reference::typedb-2-vs-3/diff.adoc#_temporarily_missing[missing features] list** before starting your migration.
Some features might not yet be available in 3.x, and you may need to wait for a newer version to proceed.
. Refresh your knowledge and adjust to the new versions of TypeDB and TypeQL by following the updated xref:{page-version}@new_home::get_started/setup.adoc[Get started] guide.
...
Consult xref:{page-version}@new_reference::typedb-2-vs-3/diff.adoc#_major_changes_drivers[major driver changes] list for details.

[#_step_by_step]
== Step-by-step example

This section showcases a step-by-step example of migrating a database between TypeDB 2.x and TypeDB 3.x using xref:{page-version}@new_maintenance_operation::database-export-import.adoc[export and import].
...
[,typeql]
----
include::{page-version}@new_reference::partial$2_to_3/schema-2x.tql[tag=full-query]
----
====
...
[,typeql]
----
include::{page-version}@new_reference::partial$2_to_3/attribute-migration-queries.tql[tag=step1-define-entity-ownership]
----
...
[,typeql]
----
include::{page-version}@new_reference::partial$2_to_3/attribute-migration-queries.tql[tag=step2-move-data]
----
...
[,typeql]
----
include::{page-version}@new_reference::partial$2_to_3/attribute-migration-queries.tql[tag=step3-undefine-attribute-ownership]
----
...
- The xref:{page-version}@new_reference::typedb-2-vs-3/diff.adoc[major changes] page highlights the most common updates needed.
...
[,typeql]
----
include::{page-version}@new_reference::partial$2_to_3/schema-3x.tql[tag=full-query]
----
...
Visit xref:{page-version}@new_reference::typedb-2-vs-3/diff.adoc[] and xref:{page-version}@new_core_concepts::index.adoc[] to learn more about TypeDB 3.x.
Enjoy your journey!

[#_having_troubles]
== Having troubles?

For troubleshooting tips and guidance, refer to the xref:{page-version}@new_maintenance_operation::troubleshooting/index.adoc[Troubleshooting pages].
