= Conjunctions
:page-aliases: {page-version}@reference::typeql/patterns/conjunction.adoc
...
xref:{page-version}@reference::typeql/pipelines/match.adoc[match clause].
...
[,typeql,indent=0]
----
include::{page-version}@reference::example$tql/conjunction.tql[tags=conjunction-example]
----
