...
:test-python: true
:page-aliases: {page-version}@drivers::java/overview.adoc, {page-version}@drivers::python/overview.adoc, {page-version}@drivers::rust/overview.adoc, {page-version}@drivers::nodejs/overview.adoc, {page-version}@drivers::csharp/overview.adoc, {page-version}@drivers::cpp/overview.adoc, {page-version}@drivers::c/overview.adoc
...
Check out the available xref:{page-version}@reference::typedb-grpc-drivers/index.adoc[gRPC drivers] and xref:{page-version}@reference::typedb-http-drivers/index.adoc[HTTP helper libraries] to find a driver that works for you.
...
The server's HTTP endpoint may also be abstracted away behind xref:{page-version}@reference::typedb-http-drivers/index.adoc[HTTP driver libraries] in your language. These libraries offer a similar interface to the gRPC driver libraries.
...
* Start with **xref:{page-version}@core-concepts::drivers/connections.adoc[Connections]** to learn about establishing server connections
* Learn about **xref:{page-version}@core-concepts::drivers/authentication.adoc[Authentication]** for secure access
* Understand **xref:{page-version}@core-concepts::drivers/transactions.adoc[Transactions]** for data consistency
* Use **xref:{page-version}@core-concepts::drivers/queries.adoc[Queries]** for reading and writing schema and data
* **xref:{page-version}@core-concepts::drivers/best-practices.adoc[Best Practices]** for ideal approaches and some tips and tricks
