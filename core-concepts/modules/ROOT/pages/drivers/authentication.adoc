...
#!test
#{{
include::{page-version}@core-concepts::example$driver/python_driver_setup.py[tag=import]
#}}
...
#{{
include::{page-version}@core-concepts::example$driver/python_driver_setup.py[tag=constants_address]
include::{page-version}@core-concepts::example$driver/python_driver_setup.py[tag=constants_options]
#}}
