...
Here, `$p` is an input to the negation. `$e, $c` are internal. The query returns the following rows:
----
   -------------
...
== Reference
* xref:{page-version}@typeql-reference::statements/index.adoc[Constraints]
* xref:{page-version}@typeql-reference::statements/index.adoc[TypeQL Patterns]
* xref:{page-version}@typeql-reference::data-model.adoc#modes[Variable modes]
