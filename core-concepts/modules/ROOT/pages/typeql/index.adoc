...
This section aims to develop a deeper, intuitive understanding of TypeQL.
It provides an overview of the language - focusing on explaining the core concepts
and leaving the details to the xref:{page-version}@typeql-reference::index.adoc[TypeQL reference].
