...
=== Relation
Relations are types with one-or-more associated "role" types.
An instance of a relation "depends" on instances of other types which "play" these roles.
...
=== Attribute
Attributes are types which hold a value.
