...
It provides an overview of the language, leaving the details to the TypeQL reference,
with relevant sections linked at the end of each page.
...
[.clickable]
****
Covers advanced typing constraints available in TypeQL
Cardinality constraints & restrictions on the values of attribute value
****
