...
See xref:{page-version}@core_concepts::typeql/schema-data.adoc[].
====
...
As mentioned above, the scope of variable names in TypeQL is the xref:{page-version}@core_concepts::typeql/query-clauses.adoc[pipeline].
...
* xref:{page-version}@reference::typeql/data_model.adoc#modes[Variable modes]
