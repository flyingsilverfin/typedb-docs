...
For more information on defining a schema and the TypeDB data model, refer to the xref:{page-version}@new_core_concepts::typeql/entities-relations-attributes.adoc[]
documentation.
