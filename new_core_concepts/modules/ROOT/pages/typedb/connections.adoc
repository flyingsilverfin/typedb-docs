...
xref:{page-version}@core_concepts::drivers/index.adoc[TypeDB driver] for your chosen programming language (e.g., Python, Java, Rust, Node.js) or through a tool like the TypeDB Console or TypeDB Studio.
...
For programmatic access using gRPC, use one of the TypeDB xref:{page-version}@core_concepts::drivers/connections.adoc[driver to connect] via the network API.
