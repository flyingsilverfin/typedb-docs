...
- xref::{page-version}@reference$typedb-grpc-drivers/rust.adoc#_QueryAnswer#_enum_QueryAnswer[Rust gRPC driver]
...
* **xref:{page-version}@core_concepts::drivers/best-practices.adoc[Best Practices]** - Advanced patterns for query optimization and error handling
