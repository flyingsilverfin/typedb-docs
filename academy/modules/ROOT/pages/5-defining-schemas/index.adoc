...
.xref:{page-version}@academy::5-defining-schemas/5.4-defining-functions.adoc[]
[.clickable]
****
...
_-> Commit_:: *Run* this query and then *commit* the transaction, persisting the changes to the database. *_Do not run_*:: Do not run this query, which is shown for information only. To rollback an open transaction, *close* it without committing.
*_Try running_*:: *Run* this query to see the error generated.
