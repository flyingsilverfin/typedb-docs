...
[.clickable]
****
Learn how to read data from TypeDB, including declarative polymorphic querying, invoking functions, and retrieving types from the schema.
****
...
[.clickable]
****
Learn how to define schemas for TypeDB, including type hierarchies, interfaces between types, value constraints, and function.
****
...
Material covering querying and modeling in depth, sufficient to take applications to production. Learn how to write more complex queries using the full range of TypeQL's syntax, and how to use types and fucntions to build more powerful and expressive schemas.
...
.xref:{page-version}@academy::8-composing-clauses/index.adoc[]
[.clickable]
****
...
Material covering TypeDB's most advanced features, for building optimised and scalable applications. Create elegant type-theoretic data models.

[cols-2]
--
.xref:{page-version}@academy::11-advanced-modeling/index.adoc[]
[.clickable]
****
