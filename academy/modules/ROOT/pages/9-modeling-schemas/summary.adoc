...
* When building a relation type hierarchy, if role players of the relation supertype should also be role players of the relation subtypes, then the relevant role should be inherited. If not, the role should be overridden.
...
== xref:{page-version}@academy::9-modeling-schemas/9.8-abstract-contracts.adoc[Abstract contracts]
...
[.clickable]
****
Learn how to use functions to abstract complex patterns into simple forms, and capture complex logic with combinations of functions.
****
